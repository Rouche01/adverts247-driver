      ...
      <View style={styles.body}>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            For a smooth and efficient app experience, Adverts247 need your
            below permissions to access and collect information. You can suspend
            your permission or uninstall App from your device at any time.
          </Text>
        </View>
        <View style={styles.permissionGroup}>
          ...
          <View style={styles.groupInfo}>
            ...
            <Text style={styles.groupBody}>
              We may collect your current location to verify your location and
        ...
        <View style={styles.permissionGroup}>
          ...
          <View style={styles.groupInfo}>
            ...
            <Text style={styles.groupBody}>
              We may collect your images & documents to access information for
              the verification of your profile.
            </Text>
          </View>
        </View>
      </View>
