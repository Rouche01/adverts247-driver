...
const ExtraInfoScreen = ({ navigation }) => {
  ...
  const onSignup = () => {
    ...
    const { email, name, phoneNumber, password, city } =
      navigation.state.params.registerInfo;
    if (validated) {
    ...
    <View style={styles.mainContainer}>
      <ScrollView style={styles.formContainer}>
        ...
        <Text style={styles.subText}>
          Help your riders know a bit more about you, by sharing some intersting
          personal info.
        </Text>
        <CustomInput
          ...
          margin={10}
          validationError={
            validationErrors.favouriteMeal &&
            validationErrors.favouriteMeal.length > 0
              ? validationErrors.favouriteMeal
              : null
          }
        />
        <CustomInput
          ...
          margin={10}
          validationError={
            validationErrors.favouriteHobby &&
            validationErrors.favouriteHobby.length > 0
              ? validationErrors.favouriteHobby
              : null
          }
        />
        <CustomInput
          ...
          margin={10}
          validationError={
            validationErrors.vacationSpot &&
            validationErrors.vacationSpot.length > 0
              ? validationErrors.vacationSpot
              : null
          }
        />
        <CustomInput
          ...
          validationError={
            validationErrors.askMeAbout &&
            validationErrors.askMeAbout.length > 0
              ? validationErrors.askMeAbout
              : null
          }
        />
